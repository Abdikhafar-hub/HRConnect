...
import { Home, Search, User, Star, Settings, Bell, LogOut, ChevronLeft, ChevronRight } from "lucide-react"
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          <Avatar className="w-10 h-10">
            ...
            <AvatarFallback>{user ? `${user.firstName[0] || ''}${user.lastName[0] || ''}` : 'JM'}</AvatarFallback>
          </Avatar>
          {!collapsed && (
